...
function draw() {
	...
	// fish 1
	ellipse(canyon.x_pos + 23, floorPos_y + 25, 15, 10);
	...
	// COLLECTABLE
	if (dist(gameChar_x, gameChar_y, collectable.x_pos, collectable.y_pos) <= 35) {
	...
	if (gameChar_x - 10 > canyon.x_pos && gameChar_x + 10 < canyon.x_pos + canyon.width && gameChar_y >= floorPos_y) {
		isPlummeting = true;
	};
