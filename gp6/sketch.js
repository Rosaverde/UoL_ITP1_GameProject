...
function draw() {
	...
	fill(255,0,0)
	textSize(24)
	text("Score: " + game_score, cameraPosX + 10, 30)
	
	fill(255,0,0)
	textSize(24)
	text("Lives: " + lives, cameraPosX + 10, 60)
...
function checkCollectable(t_collectable) {
	if (dist(gameChar_x, gameChar_y, t_collectable.x_pos, t_collectable.y_pos) <= t_collectable.size) {
		...
		/// Adding score if collectable is not found
...
// Drawing functions for background elements
